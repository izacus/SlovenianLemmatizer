...
#ifndef YY_@_OUTPUT_START
#define YY_@_OUTPUT_START fprintf (stderr,
#endif
#ifndef YY_@_OUTPUT_END
#define YY_@_OUTPUT_END )
#endif
...
#if YY_@_DEBUG != 0
  if (YY_@_DEBUG_FLAG)
    YY_@_OUTPUT_START "Starting parse\n" YY_@_OUTPUT_END;
#endif
  yystate = 0;
  yyerrstatus = 0;
  YY_@_NERRS = 0;
...
#if YY_@_DEBUG != 0
      if (YY_@_DEBUG_FLAG)
	YY_@_OUTPUT_START "Stack size increased to %d\n", yystacksize YY_@_OUTPUT_END;
#endif
...
#if YY_@_DEBUG != 0
  if (YY_@_DEBUG_FLAG)
    YY_@_OUTPUT_START "Entering state %d\n", yystate YY_@_OUTPUT_END;
#endif
...
#if YY_@_DEBUG != 0
      if (YY_@_DEBUG_FLAG)
	YY_@_OUTPUT_START "Reading a token: " YY_@_OUTPUT_END;
#endif
      YY_@_CHAR = YYLEX;
    }
...
#if YY_@_DEBUG != 0
      if (YY_@_DEBUG_FLAG)
	YY_@_OUTPUT_START "Now at end of input.\n" YY_@_OUTPUT_END;
#endif
    }
  else
    {
      ...
      if (YY_@_DEBUG_FLAG)
	{
	  YY_@_OUTPUT_START "Next token is %d (%s", YY_@_CHAR, yytname[yychar1] YY_@_OUTPUT_END;
...
#if YY_@_DEBUG != 0
  if (YY_@_DEBUG_FLAG)
    YY_@_OUTPUT_START "Shifting token %d (%s), ", YY_@_CHAR, yytname[yychar1] YY_@_OUTPUT_END;
#endif
  ...
  if (YY_@_DEBUG_FLAG)
    {
      ...
      YY_@_OUTPUT_START "Reducing via rule %d (line %d), ",
	       yyn, yyrline[yyn] YY_@_OUTPUT_END;

      /* Print the symbols being reduced, and their result.  */
      for (i = yyprhs[yyn]; yyrhs[i] > 0; i++)
	YY_@_OUTPUT_START "%s ", yytname[yyrhs[i]] YY_@_OUTPUT_END;
      YY_@_OUTPUT_START " -> %s\n", yytname[yyr1[yyn]] YY_@_OUTPUT_END;
    }
#endif
...
$   /* the action file gets copied in in place of this dollarsign  */
  ...
  if (YY_@_DEBUG_FLAG)
    {
      short *ssp1 = yyss - 1;
      YY_@_OUTPUT_START "state stack now" YY_@_OUTPUT_END;
      while (ssp1 != yyssp)
	YY_@_OUTPUT_START " %d", *++ssp1 YY_@_OUTPUT_END;
      YY_@_OUTPUT_START "\n" YY_@_OUTPUT_END;
    }
#endif
...
#if YY_@_DEBUG != 0
      if (YY_@_DEBUG_FLAG)
	YY_@_OUTPUT_START "Discarding token %d (%s).\n", YY_@_CHAR, yytname[yychar1] YY_@_OUTPUT_END;
#endif
...
YYLABEL(yyerrpop)   /* pop the current state because it cannot handle the error token */
  ...
  if (YY_@_DEBUG_FLAG)
    {
      short *ssp1 = yyss - 1;
      YY_@_OUTPUT_START "Error: state stack now" YY_@_OUTPUT_END;
      while (ssp1 != yyssp)
	YY_@_OUTPUT_START " %d", *++ssp1 YY_@_OUTPUT_END;
      YY_@_OUTPUT_START "\n" YY_@_OUTPUT_END;
    }
...
#if YY_@_DEBUG != 0
  if (YY_@_DEBUG_FLAG)
    YY_@_OUTPUT_START "Shifting error token, " YY_@_OUTPUT_END;
#endif
